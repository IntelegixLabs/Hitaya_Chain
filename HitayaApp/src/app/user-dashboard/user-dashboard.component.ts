...
export class UserDashboardComponent implements OnInit {
  ...
  constructor(private hit_token_servie: SmartContractServicesService, private router: Router) {
  ...
  expense_update() {
    ...
    this.myChart2.data.datasets[0].data = [0, 0, 0, 0, this.income];
    this.myChart3.data.datasets[0].data = [0, 0, 0, 0, this.income];
    this.myChart3.data.datasets[1].data = [0, 0, 0, 0, this.expences];
